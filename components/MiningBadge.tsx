export default function MiningBadge() {
  return (
    <a
      ...
      className="group inline-flex items-center gap-2 border border-[#2a2a2a] px-3 py-1.5 font-mono text-[10px] tracking-widest uppercase text-[#555555] hover:text-[#f0c846] hover:border-[#f0c846] transition-colors duration-200"
